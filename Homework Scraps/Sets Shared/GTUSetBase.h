...
namespace GTUContainers{
	...
	public:
		...
		//Iterator methods
		virtual Iterator find(const T& data) const = 0; // Returns the iterator which points to given data
		virtual Iterator begin() const = 0; //Sets iterator to head of the set
		virtual Iterator end() const = 0; //Sets iterator to end of the set(nullptr)
